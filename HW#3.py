...
usd_byn_rate = 2.46
# 20. Сделать if в котором будет условие: если mult_int больше
# comp_item, то вывести в консоль (“Переменная mult_int больше”, comp_item)
...
div_int = int_item / 2
#  22. Сделать if в котором будет условие: если div_int меньше comp_item, то
#  вывести в консоль (“Переменная div_int меньше”, comp_item)
...
item_1 = int_item + 10
# 24. Сделать if в котором будет условие: если item_1 меньше comp_item, то вывести
# в консоль (“Переменная item_1 меньше”, comp_item), иначе, вывести в консоль
